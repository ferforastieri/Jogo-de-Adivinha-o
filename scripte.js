...
function mostraConseguiuPrimeira(){
    ...
    document.write("<h2 style='font-family:monospace; text-align:center; padding-top: 300px;'>" + "Uau! Você acertou na primeira tentativa, linda e inteligente pois eu pensei no " + numeroPensado+ "." + "<br><br><button onClick='window.location.reload()'>Jogar outra vez</button>" + "</h2>" );
}
...
function mostraVoceConseguiu(){
    ...
    document.write("<body style='background-image: linear-gradient(#D9AFD9, #97D9E1);'></body>")
    document.write("<h2 style='font-family:monospace; text-align:center; padding-top: 300px;'>" + "Você conseguiu, acertou em " + numeroTentativas+ " tentativas, maravilhosa e inteligente pois eu pensei no " + numeroPensado+ "." + "<br><br><button onClick='window.location.reload()'>Jogar outra vez</button>" + "</h2>" );
}
...
function mostraVocePerdeu(){
    ...
    document.write("<body style='background-image: linear-gradient(#D9AFD9, #97D9E1);'></body>")
    document.write("<h2 style='font-family:monospace; text-align:center; padding-top: 300px;'>" + "Parece que você não é tão bom em adivinhação, mas voce continua linda e inteligente, você usou todas suas tentativas, o número era " + numeroPensado + "." + "<br><br><button onClick='window.location.reload()'>Tentar outra vez</button>" + "</h2>")
}
